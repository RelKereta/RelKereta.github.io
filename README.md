...
* **Faceting:** After some feedback on the accessibility issue of the overlapping section of the visualization, I was given the suggestion to make it so that the visualization be faceted so it is easier to read and understand the visualization[cite: 2]. Having the visualization be faceted also helps with making it so that it can be printed in black and white
